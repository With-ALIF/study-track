...
insert into chapters (subject_name, chapter_number, chapter_name) values
  ...
  ('Physics', 8, 'P-01: তরঙ্গ ও গতিবিদ্যা'),
  ('Physics', 9, 'P-01: আদর্শ গ্যাস ও গ্যাসের গতিতত্ত্ব'),
  ('Physics', 10, 'P-02: তাপগতিবিদ্যা'),
  ('Physics', 11, 'P-02: স্থির তড়িৎ'),
  ('Physics', 12, 'P-02: চল তড়িৎ'),
  ('Physics', 13, 'P-02: তড়িৎ প্রবাহের চৌম্বক ক্রিয়া ও চৌম্বকত্ব'),
  ('Physics', 14, 'P-02: তড়িতচৌম্বকীয় আবেশ ও পরিবর্তী প্রবাহ'),
  ('Physics', 15, 'P-02: জ্যামিতিক আলোকবিজ্ঞান'),
  ('Physics', 16, 'P-02: ভৌত আলোকবিজ্ঞান'),
  ('Physics', 17, 'P-02: আধুনিক পদার্থবিজ্ঞান'),
  ('Physics', 18, 'P-02: পরমাণুর মডেল এবং নিউক্লিয়ার পদার্থবিজ্ঞান'),
  ('Physics', 19, 'P-02: সেমিকন্ডাক্টর ও ইলেক্ট্রনিক্স'),
  ('Physics', 20, 'P-02: জ্যোতির্বিজ্ঞান');
